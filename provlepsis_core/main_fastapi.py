...
from .routers import gds, emb_fastrp, emb_node2vec, emb_graphsage, emb_hashgnn, emb_tgn, lp, split, metrics, query, ingest, gds_meta, gds_context, gds_store, lp_iter, tgn_direct
...
app.include_router(tgn_direct.router, prefix="/tgn-direct", tags=["tgn-direct"])
